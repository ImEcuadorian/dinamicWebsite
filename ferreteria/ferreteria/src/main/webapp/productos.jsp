        ...
        <div class="row g-4">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/small-hammer-599.glb" alt="Martillo" camera-controls shadow-intensity="1"></model-viewer>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/screwdriver-591.glb" alt="Destornillador" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/minecraft_axe.glb" alt="Hacha" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/minecraft_shovel.glb" alt="Pala" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/garden-rake-2047.glb" alt="Rastrillo" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/minecraft_carrito.glb" alt="Carretilla" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/minecraft_pickaxe.glb" alt="Pico" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/toothed-spatula-618.glb" alt="Espátula Dentada" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="card producto shadow-sm">
                    <model-viewer src="model3D/door-920.glb" alt="Puerta de Madera" camera-controls shadow-intensity="1"></model-viewer>
                    <div class="card-body text-center">
