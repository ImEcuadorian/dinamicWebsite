      ...
      <div class="col-lg-6">
        <div class="card shadow-sm border-0">
          <div class="card-body">
            ...
            <div>
              <a href="https://www.facebook.com/jossue.proano" class="text-primary me-3"><i class="fa-brands fa-facebook fa-2x"></i></a>
              <a href="https://www.instagram.com/jossh_8/" class="text-danger me-3"><i class="fa-brands fa-instagram fa-2x"></i></a>
