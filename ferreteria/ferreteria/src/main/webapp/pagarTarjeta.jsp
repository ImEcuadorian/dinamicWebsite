...
<div class="card card-pago">
    ...
    <form action="validarPagoTarjeta.jsp" method="post">
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" maxlength="16" name="numero" class="form-control form-control-lg" placeholder="•••• •••• •••• ••••" required>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="password" maxlength="4" name="cvv" class="form-control form-control-lg" placeholder="•••" required>
        </div>
