...
<div class="mb-3">
  ...
  <div class="form-check form-check-inline">
    <input class="form-check-input" type="radio" name="enOferta" value="true" <%= (p.getEnOferta() ? "checked" : "") %>> Sí
  </div>
  <div class="form-check form-check-inline">
    <input class="form-check-input" type="radio" name="enOferta" value="false" <%= (!p.getEnOferta() ? "checked" : "") %>> No
  </div>
</div>

<div class="mb-3">
  <label for="descuento" class="form-label">Descuento (%)</label>
  <input type="number" name="descuento" step="1" min="0" max="100" value="<%= p.getDescuento() %>" class="form-control">
</div>
