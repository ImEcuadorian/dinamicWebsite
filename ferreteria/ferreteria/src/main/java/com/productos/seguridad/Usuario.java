...
//    }
    ...
    public String consultarUsuarios() {
        ...
        try {
            ...
            try { if (rs != null) rs.close(); con.getConexion().close(); } catch (Exception e) {}
        }
...
//    }
    ...
    public String eliminarUsuario(String id) {
        ...
        try {
            ...
            try { con.getConexion().close(); } catch(Exception e) {}
        }
        return msg;
    }
    ...
    public String actualizarUsuario(Usuario user) {
        ...
        try {
            ...
            try { if (ps != null) ps.close(); con.getConexion().close(); } catch (Exception e) {}
        }
        return result;
    }
    ...
    public String ingresarEmpleado() {
        ...
        try {
            ...
            try { if (pr != null) pr.close(); con.getConexion().close(); } catch (Exception e) { }
        }
